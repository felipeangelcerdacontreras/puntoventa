<?php
    ...
    //if($_SESSION['logged'] != "OK" || $_SESSION['tipo'] != "Administrador") die("Accesso No Autorizado");
?>
<!DOCTYPE html>
<html>
<head>
	        ...
	        <div class="row">
	            ...
	            <div class="col-lg-3 col-md-6">
	                <div class="panel panel-primary">
	                    ...
	                    <a href="clientes/clientes_menu.php">
	                ...
	                <div class="panel panel-primary">
	                    ...
	                    <a href="#">
	                        <div class="panel-footer">
	                            <span class="pull-left">Ir a notas de venta</span>
	                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
	                            <div class="clearfix"></div>
	                        </div>
	                    </a>
	                ...
	                <div class="panel panel-primary">
	                    ...
	                    <a href="clientes/clientes_menu.php">
	                        <div class="panel-footer">
	                            <span class="pull-left">Ir a pedidos</span>
	                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
	                            <div class="clearfix"></div>
	                        </div>
	                    </a>
