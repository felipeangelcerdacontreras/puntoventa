    ...
    <div id="page-wrapper" style="margin-left: 0px; background-color:#e5e5dd;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <!-- <div class="row" style="color: blue;" id="divUnidades2" hidden>
                    <div class="col-md-4"><label style="font-size: 24px;">Peso:</label></div>
                    <div class="col-md-8"><input type="number" id="unidades" class="form-control"></div>
                    <label style="font-size: 45px;">kg</label>
                </div> -->
        ...
        <div class="row">
            <div class=" col-md-8" style="font-size: 18px;">
                <div class="col-md-6">
                    ...
                    <input type="text" id="nombreArticulo" class="form-control" list="articulos" placeholder="Escoge un artículo" onchange="selecArticulo()">
