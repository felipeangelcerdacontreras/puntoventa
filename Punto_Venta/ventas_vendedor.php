...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="margin-left: 0px; background-color:#e5e5dd;">
    	<div class="row">
    		<div class="col-lg-12">
    			<h3 class="page-header">Historial de Ventas</h3>
    		</div>
    	</div>
        <div class="row" >
            <div class="col-md-1">
                <input id="movimiento" type="button" class="btn btn-primary" onclick="window.location.href = './movimientosUsuario.php'" value="movimientos">
            </div>
            ...
            <div class="col-md-1">
              <input id="filtrar" type="button" class="btn btn-primary" onclick="filtroFecha_Ventas(1)" value="Filtrar">
            </div>
            <div class="col-md-2">
