...
<head>
	...
	<script type="text/javascript">ventasporProducto();</script>
    <script type="text/javascript">
        function imprimirHistorialVentasProducto() {
            var desde = document.getElementById('fechaVentasDesde').value;
            var hasta  = document.getElementById('fechaVentasHasta').value;     
            window.location="php/imprime_ventas_producto.php?fechaDesde="+desde+"&fechaHasta="+hasta;
        }
    </script>
</head>
<body>
<div id="wrapper">
    ...
    <div id="page-wrapper" style="margin-left: 0px; background-color:#e5e5dd;">
    	<div class="row">
    		<div class="col-lg-12">
    			<h3 class="page-header">Historial de Ventas por Producto</h3>
    		</div>
    	</div>
        <div class="row" >
            ...
            <div class="col-md-1">
              <input id="filtrar" type="button" class="btn btn-primary" onclick="ventasporProductoFiltro()" value="Filtrar">
            </div>
            <div class="col-md-1">
              <input id="filtrar" type="button" class="btn btn-primary" onclick="imprimirHistorialVentasProducto()" value="Imprimir">
            </div>
            <div class="col-md-2">
