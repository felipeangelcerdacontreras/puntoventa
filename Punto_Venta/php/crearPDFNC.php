<?php  
    ...
    $conceptos = mysqli_query($con, "Select conceptosNC.* from conceptosNC where id_xml = $id_xml");
    $XML = mysqli_query($con, "Select xmlNC.*, nro_cuenta from xmlNC left join venta on venta.id_venta = xmlNC.id_venta where id = $id_xml");
    ...
    $pdf->SetXY(20, 20);
    $pdf->Cell(60, 0, $pdf->Image('../img/prodika.png', 20, 20, 85, 25), 0, 0, 'C');

    //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  Datos Factura  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
    $pdf->SetFont('Arial','B', 10);
    $pdf->SetXY(123, 20);
    $pdf->Cell(40, 7, utf8_decode('Nota de Crédito'), 0, 1, 'L', 0);
