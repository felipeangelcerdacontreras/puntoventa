...
function imprSelec()
  {
    ...
    //alert("DESDE: "+desde+" HASTA: "+hasta+" ID USER: "+id_user);
     ...
     window.location="./corte_deCaja_2.php";
  }
</script>   
<div class="col-md-12" >
...
$retirofinal = mysqli_query($con, "INSERT INTO retiros(id_retiro, id_caja, fecha, monto) VALUES (null, '".$id_user."', '".$fecha."', '".$ban."')");
