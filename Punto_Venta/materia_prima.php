...
<head>
    ...
    <script type="text/javascript">
      function imprimir_articulos()
      {
       //alert('Inventario');
       //alert("id_venta: "+id_venta+" recibido: "+recibido+" cambio: "+cambio+" total descuento: "+total_sincoma);
       //window.open("php/imprime_inventario.php",'','width=600,height=400,left=50,top=50,toolbar=yes');
       window.location="php/imprime_inventario.php";
      }
    </script>
</head>
<body>
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color:#337AB7;">
        ...
        <form id="perfil" method="POST">
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a href="./inventario.php" style="color:white;"><i class="fa fa-reply fa-fw"></i> Regresar</a>
                </li>
                <li class="dropdown">
    ...
    <div id="page-wrapper" style="margin-left: 0px; background-color:#e5e5dd;">
        <div class="row">
            <div class="col-md-6">
             ...
             <div class="col-md-2">
                <br>
                <a href="#" class="btn btn-primary" style="font-size: 20px;" onclick="imprimir_articulos()"> <i class="fa fa-plus-circle"></i> Imprimir</a>
            </div>
            <div class="col-md-2">
                <br>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4" style="text-align: right;"><h4><label>Categoría:</label></h4></div>
                            <div class="col-md-6">
                                <select id="categoria_materiaP" class="form-control">
                                <option value="0">Seleccione el categoría...</option>
                                <option value="POLLO">POLLO</option>
                                <option value="RES">RES</option>
                                <option value="CERDO">CERDO</option>
                                <option value="ABARROTES">ABARROTES</option>
                                <option value="SALCHICHONERIA">SALCHICHONERIA</option>
        ...
        <div class="modal fade" id="modal_ventaMateriaPrima" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body" id="body_modal_materiaPrima"></div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Cerrar</button>
                    </div>
                </div>
        ...
        <div class="modal fade" id="modal_eliminar" role="dialog" aria-hidden="true">
            <div class="modal-dialog" >
              <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4  align="center" class="modal-title" id="myModalLabel">Quitar Producto Materia Prima</h4>
              </div>
              <div class="modal-body">
                <div class="row" style="text-align: center;">
                    <div class="col-md-12" >
                        ...
                        <input type="hidden" id="id_articuloMATPRIM">
                        <input type="password" id="code_MATPRIM">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <input type="button" class="btn btn-primary" value="Quitar" onclick="ElimMateriaPrima()">
            </div>
          </div>
         </div>
        </div>
